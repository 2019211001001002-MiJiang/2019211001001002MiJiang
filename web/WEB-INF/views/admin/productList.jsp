<%@ page import="main.java.com.MiJiang.model.Product" %>
					...
					<c:forEach var="p" items="${productList}">
						<tr>
							...
							<%
								...
								main.java.com.MiJiang.model.Product p=(main.java.com.MiJiang.model.Product)pageContext.findAttribute("p");
								int pid=p.getCategoryId();
								Connection con=(Connection)application.getAttribute("con");
								String catName=main.java.com.MiJiang.model.Category.findByCategoryId(con,pid);
							%>
