			...
			<div class="table-responsive col-sm-10">
				...
				<thead>
					...
					<c:forEach var="o" items="${orderList}">
						...
						<td>${o.orderDate}</td>
						<%
							main.java.com.MiJiang.model.Order o=(main.java.com.MiJiang.model.Order)pageContext.findAttribute("o");
							int userId=o.getCustomerId();
							java.sql.Connection con=(java.sql.Connection)application.getAttribute("con");
							main.java.com.MiJiang.dao.UserDao userDao=new main.java.com.MiJiang.dao.UserDao();
						...
						<%
							...
							String paymentType=main.java.com.MiJiang.model.Payment.findByPaymentId(con,n);
							 %>
